     ...
     <header class="mt-50">
         ...
         <div class="tag-line-slider">
             <h2 class="tag-line-title">Bekerja Di Rumah Sebagai Online Tester</h2>
             <p class="tag-line-desc">Dengan Kuisioner.com anda akan mudah mendapatkan uang hanya bermodalkan gadget atau laptop dari rumah</p>
         </div>
